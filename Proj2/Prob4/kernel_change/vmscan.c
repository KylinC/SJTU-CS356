						  ...
						  struct scan_control *sc)
{
	...
	unsigned long tmp_RankMyDefine;

	referenced_ptes = page_referenced(page, 1, mz->mem_cgroup, &vm_flags);
	referenced_page = TestClearPageReferenced(page);
    
    tmp_RankMyDefine=page->RankMyDefine;
    page->RankMyDefine /= 2;
	...
	if (referenced_ptes) {
		...
		printk(KERN_INFO"%ld:Found referenced in shrink_inactive_list, activate page referenced by adding 2.\n",page->index);
	...
	if (tmp_RankMyDefine>2 && !PageSwapBacked(page))
